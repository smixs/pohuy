...
<p align="center">
  Охуенный скилл. Та же точность, но быстрее.<br>
...
лучше сем Caveman. Caveman экономит слова. Похуй экономит похуй.
...
> Код заебись, сливай. Доёбываться не буду, но `data2` — это, конечно, пизда: с хуя ли 2?
...
> Латенси по пизде пошла: `events` растёт как сиськи бывшей, индекса нет, запрос ебет мозги. Индекс переебал — стало охуенно: 40ms вместо двух секунд.
...
> Локально заебись, на проде хуй там. Значит, env расходится. Хуй знает где пока, ща.
...
Технического не потеряно нихуя. Душевного — дохуя.
...
Цифры честные, беспезды см. [ЧЕСТНЫЕ-ЦИФРЫ.md](./ЧЕСТНЫЕ-ЦИФРЫ.md). Спойлер: токенов не экономит нихуя.
...
3. Всё. Хуков, статистик и дашбордов нет — а на кой хуй. Аутентичность — это когда без телеметрии.
